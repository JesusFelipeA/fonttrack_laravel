...
{
    /**
     * ✅ MODIFICADO: Vista filtrada por lugar del usuario
     */
    public function index(Request $request)
    {
        ...
        // ✅ FILTRAR MATERIALES POR LUGAR DEL USUARIO
        $materiales = Material::when($user->tipo_usuario != 1 && $user->id_lugar, function($q) use ($user) {
    ...
    /**
     * ✅ NUEVO: Obtener vehículos por lugar
     */
    ...
    /**
     * ✅ NUEVO: Obtener datos específicos de un vehículo por ECO
     */
    ...
    // (Aquí van todos los métodos originales sin cambios)
    ...
    private function enviarCorreo($reporteId, $pdfContent, $correoDestino)
    {
        try {
            ...
            // Crear objeto mock para compatibilidad con ReporteFalla
            $fallaObject = (object) [
                'id' => $reporte->id,
