...
class Notificacion extends Model
{
    ...
    /**
     * Notificaciones de un lugar específico
     */
    ...
    /**
     * Obtiene materiales formateados para mostrar
     */
    public function getMaterialesFormateadosAttribute()
    {
        ...
        if (!empty($this->materials) && is_array($this->materials)) {
            return collect($this->materials)->map(function ($material) {
                ...
                // PRIORIDAD 1: Usar descripción del array si existe
                $descripcion = 'Material no especificado';
                if (!empty($material['descripcion'])) {
                    $descripcion = $material['descripcion'];
                }
                // PRIORIDAD 2: Buscar en BD por ID
                elseif ($materialId) {
                ...
                // PRIORIDAD 3: Buscar en otras claves del array
    ...
    /**
     * Verifica si la notificación está aprobada
     */
    ...
    /**
     * Verifica si la notificación está rechazada
     */
    ...
    /**
     * Marca la notificación como aprobada y la convierte a Falla
     * IMPORTANTE: Esto ELIMINA la notificación después de crear la falla
     */
    public function aprobar($usuarioAdmin, $comentarios = null, $contraseña = null)
    {
        ...
        try {
            // 1. Crear la falla con todos los datos
            ...
            return $falla; // Retornamos la falla creada
    ...
    /**
     * Marca la notificación como rechazada (NO se elimina para auditoría)
     */
    ...
    public function toFallaData($usuarioAdmin, $contraseña = null)
    {
        ...
        return [
            ...
            // ✅ MATERIALES - preservar AMBOS formatos
            'materials' => $materialsParaFalla,  // Array completo
            'material' => $materialParaFalla,    // Campo legacy
            'cantidad' => $cantidadParaFalla,    // Campo legacy
    ...
    protected static function boot()
    {
        ...
        // Cuando se crea una notificación, calcular el resumen de materiales
        ...
        // Log cuando cambia el estado o se elimina
        ...
        // Log cuando se elimina una notificación
