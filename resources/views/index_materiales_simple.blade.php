...
<body>
    ...
    <!-- ✅ MODAL DE REPORTE CON AUTOCOMPLETADO DE VEHÍCULOS -->
    ...
    <script>
        $(document).ready(function () {
            ...
            // ✅ FUNCIÓN DE BÚSQUEDA DE MATERIALES
            ...
            // ✅ EVENT LISTENERS PARA BÚSQUEDA DE MATERIALES
            $('#materialSearch').on('input', function() {
                const query = $(this).val().trim();
                searchMaterials(query);
            });

            // ✅ EVENT LISTENERS PARA BÚSQUEDA DE VEHÍCULOS
            ...
            // ✅ SELECCIÓN DE VEHÍCULO Y AUTOCOMPLETADO
            $(document).on('click', '.vehicle-result-item', function() {
                ...
                $('#anoField').val(vehicleData.anio || ''); // ✅ CORREGIDO - Ahora usa el dato real
                $('#kmField').val(vehicleData.kilometraje || ''); // ✅ CORREGIDO - Ahora usa el dato real
            ...
            // ✅ FUNCIONES DE MATERIALES SELECCIONADOS
            ...
            // Al cambiar el usuario seleccionado
            ...
            $('#modalReporte').on('hidden.bs.modal', function() {
                ...
                // ✅ LIMPIAR TODOS LOS CAMPOS DE VEHÍCULO
                $('#ecoField').val('');
                $('#placasField').val('');
                $('#marcaField').val('');
                $('#anoField').val('');
